...
-- Função auxiliar que recebe um id de uma conversa e lança uma exceção caso este não
-- exista na base de dados
...
-- Função auxiliar que recebe um id de uma conversa e um id de um jogador e lança uma exceção caso
-- estes já estejam associados
